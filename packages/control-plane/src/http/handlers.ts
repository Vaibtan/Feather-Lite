...
const toSignal = (s: SignalRequest): Signal => {
  switch (s.kind) {
    ...
    case "turn_metrics":
      return { kind: "turn_metrics", turnId: s.turn_id, eouDelayMs: s.eou_delay_ms, transcriptionDelayMs: s.transcription_delay_ms, ttsTtfbMs: s.tts_ttfb_ms, ttsAudioMs: s.tts_audio_ms, ttsChars: s.tts_chars, resumedMs: s.resumed_ms };
  }
};
